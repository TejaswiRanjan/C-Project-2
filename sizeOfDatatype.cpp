...
Sample Input : Nil(Here it is expected that we explore the size of each data type would be used commonly in the programs ahead. We can simply make use of sizeof(datatype) operator to accomplish this.Give it a try to know the data types in depth)
